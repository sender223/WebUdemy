...
namespace SalesWebMvc.Data
{
    ...
    {
        //SERVICO DE POPULAR A BASE DE DADOS
        ...
        public void Seed() {
            ...
            Vendedor v1 = new Vendedor(1, "Bob Brown", "bob@gmail.com", new DateTime(1987, 4, 21), 1000.0, d1);
            Vendedor v2 = new Vendedor(2, "Maria Green", "maria@gmail.com", new DateTime(1966, 12, 30), 900.0, d2);
            Vendedor v3 = new Vendedor(3, "Alex Grey", "alex@gmail.com", new DateTime(1989, 3, 3), 850.0, d1);
            Vendedor v4 = new Vendedor(4, "Martha Red", "martha@gmail.com", new DateTime(1944, 1, 11), 1500.0, d4);
            Vendedor v5 = new Vendedor(5, "Donald Blue", "donald@gmail.com", new DateTime(1923, 2, 22), 1800.0, d3);
            Vendedor v6 = new Vendedor(6, "Alex Pink", "alex@gmail.com", new DateTime(1956, 8, 17), 6000.0, d2);
